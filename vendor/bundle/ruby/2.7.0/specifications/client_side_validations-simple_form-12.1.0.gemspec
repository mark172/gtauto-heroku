# -*- encoding: utf-8 -*-
# stub: client_side_validations-simple_form 12.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/DavyJonesLocker/client_side_validations-simple_form/issues", "changelog_uri" => "https://github.com/DavyJonesLocker/client_side_validations-simple_form/blob/main/CHANGELOG.md", "source_code_uri" => "https://github.com/DavyJonesLocker/client_side_validations-simple_form" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<client_side_validations>.freeze, [">= 15.0", "< 19.0"])
    ...
    s.add_dependency(%q<client_side_validations>.freeze, [">= 15.0", "< 19.0"])

# -*- encoding: utf-8 -*-
# stub: client_side_validations 18.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/DavyJonesLocker/client_side_validations/issues", "changelog_uri" => "https://github.com/DavyJonesLocker/client_side_validations/blob/main/CHANGELOG.md", "source_code_uri" => "https://github.com/DavyJonesLocker/client_side_validations" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rails>.freeze, [">= 5.0.0.1", "< 7.0"])
    ...
    s.add_dependency(%q<rails>.freeze, [">= 5.0.0.1", "< 7.0"])
